package com.example.a04_03_viacriadkovylayout;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void PripojAdapter() {
        ...
        int[] to = new int[]{R.id.meno_item, R.id.pro1_item, R.id.pro2_item};

        myAdapter = new SimpleAdapter(
                this,                   // kontext, štandardne aktivita
                zoznam,                  // zdroj dát
                R.layout.list_viac_riadkov, // predpis pre zobrazovanie
                from,
                to
        );
